...
Exports a CSV report of WMI objects of computers retrieved from COMPUTERS.TXT or AD (servers only).
             (ComputerName,OS,SP,InstallDate,LastBootTime,Manufacturer,Model,"PhysicalMemory(GB)",NumOfProcessors, NumOfCores,NumOfLogicalProcessors,"SerialNumber(BIOS)","SerialNumber(Encl)",LogicalDrives,PageFile)
